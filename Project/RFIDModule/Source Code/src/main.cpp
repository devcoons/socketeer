...
#include <socketeer.h>
	...
	{
		int RFIDModule_Inbound = 8012;
		int CoreModule_Outbound = 8002;
		int KeepAlive_Outbound = 8000;

		printf("Starting RFID Module..\n");
		...
		if(socketeer_client_start_keepalive("127.0.0.1",KeepAlive_Outbound,"RFIDModule") == false)
		{
